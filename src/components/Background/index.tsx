  ...
  return (
    <div>
      <div className="select-none ">
        <div className="absolute -z-10 rounded-full mix-blend-multiply filter blur-[70px] lg:blur-[120px] animate-blob
    animation-delay-1 w-40 h-40 top-56 right-10 lg:w-80 lg:h-80 lg:top-36 lg:right-96 bg-fuchsia-500">
        </div>
        <div className="absolute -z-10 rounded-full mix-blend-multiply filter blur-[70px] lg:blur-[120px] animate-blob
